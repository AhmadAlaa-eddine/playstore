...
function Apps() {
  const [items, setItems] = useState([
    ...
    { id: 2, name: 'Item 2', category: 'Top Selling', genre: 'Comedy' },
    { id: 3, name: 'Item 3', category: 'Top Selling', genre: 'Action' },
    { id: 4, name: 'Item 4', category: 'Top Selling', genre: 'Romantic' },
    { id: 5, name: 'Item 5', category: 'Top Selling', genre: 'Comedy' },
    { id: 6, name: 'Item 6', category: 'Top Selling', genre: 'Action' },
    { id: 7, name: 'Item 7', category: 'Top Selling', genre: 'Romantic' },
    { id: 8, name: 'Item 8', category: 'Top Selling', genre: 'Comedy' },
    { id: 9, name: 'Item 9', category: 'Top Selling', genre: 'Action' },
    { id: 10, name: 'Item 10', category: 'Top Selling', genre: 'Romantic' },
   
    { id: 11, name: 'Item 11', category: 'New Releases', genre: 'Romantic' },
    { id: 12, name: 'Item 12', category: 'New Releases', genre: 'Comedy' },
    { id: 13, name: 'Item 13', category: 'New Releases', genre: 'Action' },
    { id: 14, name: 'Item 14', category: 'New Releases', genre: 'Romantic' },
    { id: 15, name: 'Item 15', category: 'New Releases', genre: 'Comedy' },
    { id: 16, name: 'Item 16', category: 'New Releases', genre: 'Action' },
    { id: 17, name: 'Item 17', category: 'New Releases', genre: 'Romantic' },
    { id: 18, name: 'Item 18', category: 'New Releases', genre: 'Comedy' },
    { id: 19, name: 'Item 19', category: 'New Releases', genre: 'Action' },
    { id: 20, name: 'Item 20', category: 'New Releases', genre: 'Romantic' },
   
    
    { id: 21, name: 'Item 21', category: 'Recommended', genre: 'Romantic' },
    { id: 22, name: 'Item 22', category: 'Recommended', genre: 'Comedy' },
    { id: 23, name: 'Item 23', category: 'Recommended', genre: 'Action' },
    { id: 24, name: 'Item 24', category: 'Recommended', genre: 'Romantic' },
    { id: 25, name: 'Item 25', category: 'Recommended', genre: 'Comedy' },
    { id: 26, name: 'Item 26', category: 'Recommended', genre: 'Action' },
    { id: 27, name: 'Item 27', category: 'Recommended', genre: 'Romantic' },
    { id: 28, name: 'Item 28', category: 'Recommended', genre: 'Comedy' },
    { id: 29, name: 'Item 29', category: 'Recommended', genre: 'Action' },
